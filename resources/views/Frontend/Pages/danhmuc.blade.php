    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-xs-12">
          <article class="col-main">
            ...
            <div class="toolbar">
              ...
              <div id="sort-by">
                ...
                <ul>
                  <li><a @if ($danhmuc->id == 1)
                    href="{{asset('thoitrangnam/sortnew/'.$danhmuc->id.'.html')}}"
                  @else
                    href="{{asset('thoitrangnu/sortnew/'.$danhmuc->id.'.html')}}"
                  @endif>Mới nhất<span class="right-arrow"></span></a>
                    <ul>
                      <li><a @if ($danhmuc->id == 1)
                        href="{{asset('thoitrangnam/sortname/'.$danhmuc->id.'.html')}}"
                      @else
                        href="{{asset('thoitrangnu/sortname/'.$danhmuc->id.'.html')}}"
                      @endif>Tên</a></li>
                      <li><a @if ($danhmuc->id == 1)
                        href="{{asset('thoitrangnam/sortprice/'.$danhmuc->id.'.html')}}"
                      @else
                        href="{{asset('thoitrangnam/sortprice/'.$danhmuc->id.'.html')}}"
                      @endif">Giá</a></li>
          ...
          @if ($sapxep == 'sortnew')           
            @foreach ($danhmuc->danhmuc_sanpham2()->sortByDesc('created_at') as $items)            
              <ul class="products-grid">
                <li class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"><a class="product-image" title="Product tilte is here" href="{{asset('products-detail/'.$items->TenKhongDau.'/'.$items->id.'.html')}}"> <img alt="Product tilte is here" src="{{asset('public/upload/'.$items->AnhChinh)}}" width="250px" height="290px"> </a>
            ...
            @endforeach
          @elseif($sapxep == 'sortname')
            @foreach ($danhmuc->danhmuc_sanpham2()->sortBy('Name') as $items)            
              <ul class="products-grid">
                <li class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                  <div class="item-inner">
                    <div class="item-img">
            ...
            @endforeach
          @else
            @foreach ($danhmuc->danhmuc_sanpham2()->sortByDesc('GiaKhuyenMai') as $items)            
              <ul class="products-grid">
                <li class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                  <div class="item-inner">
                    <div class="item-img">
            ...
            <div class="toolbar bottom">
              <div class="row">
                <div class="col-sm-6 text-left">
                  <div class="pages">
                    {!!$danhmuc->danhmuc_sanpham2()->links()!!}
                  </div>
                </div>
                <div class="col-sm-6 text-right">Số lượng sản phẩm {{$danhmuc->danhmuc_sanpham2()->count()}}</div>
              </div>
            </div>
          </article>
        </div>
