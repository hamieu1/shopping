                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="{{asset('admin/loaisanpham/them')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    {{csrf_field()}}
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="Name" placeholder="Nhập tên loại sản phẩm" class="form-control"></div>
                                    </div>
